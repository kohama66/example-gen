...
func newCreditCard(db *gorm.DB, opts ...gen.DOOption) creditCard {
	...
	_creditCard.ID = field.NewInt32(tableName, "id")
	_creditCard.UserID = field.NewInt32(tableName, "user_id")
	_creditCard.CardNumber = field.NewString(tableName, "card_number")
...
func (c *creditCard) updateTableName(table string) *creditCard {
	...
	c.CardNumber = field.NewString(table, "card_number")
...
func (c *creditCard) fillFieldMap() {
	...
	c.fieldMap["card_number"] = c.CardNumber
}
